/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 8b0454fc325c8979a561923bca156797)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "PresentationSession" | "VerifierIdentity";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OFFICIAL_TRUST_REGISTRY_URL" | "TRUSTED_ISSUERS" | "VERIFIER_ORIGIN">> {}
}
