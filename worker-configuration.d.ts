/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 86f4b5b030348df59d6eda10af9ce8fa)
...
interface __BaseEnv_Env {
	...
	IDENTITY: DurableObjectNamespace<import("./src/index").VerifierIdentity>;
	ZKP_SESSIONS: DurableObjectNamespace<import("./src/index").ZkpSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PresentationSession" | "VerifierIdentity" | "ZkpSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OFFICIAL_TRUST_REGISTRY_URL" | "VERIFIER_ORIGIN" | "ZKP_VERIFIER_URL">> {}
}
